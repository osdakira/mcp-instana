...
def run_all_tests(test_path: Optional[str] = None, verbose: bool = False) -> bool:
    ...
    if test_path is None:
        ...
        test_modules = [
            ...
            'tests.automation.test_action_catalog',
            'tests.automation.test_action_history',
            'tests.custom_dashboard.test_custom_dashboard_tools',
            'tests.core.test_api_headers',
            'tests.core.test_server',
            'tests.core.test_timestamp_utils',
            ...
            'tests.prompts.application.test_application_settings',
            'tests.prompts.application.test_application_topology',
            'tests.prompts.automation.test_action_catalog',
            'tests.prompts.automation.test_action_history',
            'tests.prompts.custom_dashboard.test_custom_dashboard',
            'tests.prompts.events.test_events_tools',
            ...
            'tests.prompts.releases.test_releases_prompts',
            'tests.prompts.slo.test_slo_alert_config',
            'tests.prompts.slo.test_slo_configuration',
            'tests.prompts.slo.test_slo_correction_configuration',
            'tests.prompts.slo.test_slo_report',
            'tests.prompts.website.test_website_analyze',
            ...
            'tests.router.test_custom_dashboard_smart_router_tool',
            'tests.router.test_events_smart_router_tool',
            'tests.router.test_releases_smart_router_tool',
            'tests.router.test_slo_smart_router_tool',
            'tests.router.test_website_smart_router',
            'tests.slo.test_slo_alert_config',
            'tests.slo.test_slo_configuration',
            'tests.slo.test_slo_correction_configuration',
            'tests.slo.test_slo_report',
